    ...
    <div class="jumbotron " style="border-width: 9px;border-radius:25px;border-style:groove;border-color:#5D6D7E;">
        <div id="profile">   
                <div class="row" align="center">
                    <h2 style="color:#222222"><strong>{{$supplier->name}}</strong></h2>
                </div>
                <br>
                <div class="row" >
                    <div class="col-md-4 col-sm-4 " align="center">
                        <img style="border-radius:25px;border-style:groove;border-width:9px;border-color:#85929E ;width:200px;height:200px" src="/storage/profile_images/Suppliers/{{$supplier->profile_image}}">
                    </div>
        ...
        @if(!Auth::guest())
                <div class="row">
                    <div  class="col-md-4 col-xs-4" style="float: left;">
                        <a href="/suppliers" class="btn btn-success btn-lg">Back</a>
                    </div>
                    ...
                    <div class="col-md-4 col-xs-4" style="float: right;" align="right">
                        <a href="/suppliers/{{$supplier->id}}/edit" class="btn btn-primary btn-lg">Edit</a>
                    </div>
                </div>
        @endif
    </div>
